...
use SSIPG\ValueObjects\Values\PercentValue;
...
class PercentValueTest extends TestCase
{
    ...
    public function testFromFraction(): void
    {
        ...
        $this->assertEquals(1 / 3, $percent->value);
        ...
        $this->assertEquals(10 / 21, $percent->value);

        $this->assertNull(PercentValue::fromFraction(1, 0));
    }

    public function testFromFractionWithZeroDenominator(): void
    {
        $this->assertNull(PercentValue::fromFraction(1, 0));
        $this->assertNull(PercentValue::fromFraction(1, 0.0));
    }
